...
_MODEL_CLASSES = {
    'scibert': ModelClass(**{
        #'config': AutoConfig.from_pretrained('/home/dks/IACS/phd/avishek/Datasets/SciCite/scibert'),
        #'tokenizer': AutoTokenizer.from_pretrained('/home/dks/IACS/phd/avishek/Datasets/SciCite/scibert'),
        #'model':AutoModel.from_pretrained('/home/dks/IACS/phd/avishek/Datasets/SciCite/scibert'),
    ...
    #'scideberta': ModelClass(**{
    #    'config': DebertaConfig.from_pretrained("/home/dks/IACS/phd/avishek/Datasets/SciCite/Scideberta"),
    #    'tokenizer': DebertaTokenizer.from_pretrained("/home/dks/IACS/phd/avishek/Datasets/SciCite/Scideberta"),
    #    'model':DebertaForMaskedLM.from_pretrained("/home/dks/IACS/phd/avishek/Datasets/SciCite/Scideberta"),
    #    'wrapper': MLMTokenizerWrapper,
    #}),
    'bert': ModelClass(**{
        'config': BertConfig,
